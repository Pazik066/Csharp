...
// Первый способ в одном методе не очень удобный.
int[] GetSumPositiveNegativeElem(int[] arr)
{
    ...
    return new int[] {sumPositive, sumNegative}; // Возврат с созданием нового массива
}
// Второй способо отдельными методами более удобный и читаемый.
